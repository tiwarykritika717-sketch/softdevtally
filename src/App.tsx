...
import { FranchiseProcess } from './pages/website/FranchiseProcess';
import { PartnerWithUs } from './pages/website/PartnerWithUs';
...
export default function App() {
  useEffect(() => {
    // Standard event listeners removed as per user request to allow copying, pasting, selecting, right-clicking, and basic user interactions
  }, []);
    ...
    <AppProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/franchise-process" element={<FranchiseProcess />} />
