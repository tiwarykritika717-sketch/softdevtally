...
import { CollaborationCertificate } from '../../components/CollaborationCertificate';
import { 
  Users, 
  Wallet, 
  Award, 
...
export const FranchiseDashboard = () => {
  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-7xl mx-auto">
        ...
        <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-xl flex flex-col">
           ...
           <div 
            ...
            <div 
              ...
              className="mt-4 p-6 bg-amber-50 rounded-[2rem] border border-amber-200 relative overflow-hidden group hover:bg-amber-600 transition-all cursor-pointer animate-pulse hover:animate-none"
            >
               <div className="relative z-10 flex items-center justify-between">
                  <div>
                     <p className="text-[10px] font-black text-amber-700 uppercase tracking-widest group-hover:text-amber-100">Brand Credentials</p>
                     <p className="text-xs font-black text-[#141414] uppercase tracking-tight mt-1 group-hover:text-white font-display">Collaboration Certificate</p>
                  </div>
                  <div className="w-10 h-10 bg-amber-500 text-white rounded-full flex items-center justify-center group-hover:bg-white group-hover:text-amber-500 transition-all">
                     <Award size={18} />
                  </div>
               </div>
            </div>
      ...
      {showCertModal && currentFranchise && (
